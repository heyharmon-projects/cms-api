    ...
    public function run(): void
    {
        $websites = [
            [
                ...
                'slug' => 'acme',
                'domain' => 'acme.com',
                'settings' => json_decode('{"footer": {"menu": []}, "navbar": {"cta": {"label": "Free quote", "destination": "/quote"}, "logo": {"file": {"id": 4, "filename": "logo.svg", "extension": "svg"}}, "menu": [{"path": "/", "title": "Services"}, {"path": "/", "title": "About"}, {"path": "/", "title": "Locations"}], "phone": {"label": "(800) 123-4567", "destination": "tel:+18001234567"}}, "favicon": {"file": {"id": 5, "filename": "favicon.ico", "extension": "ico"}}}'),
